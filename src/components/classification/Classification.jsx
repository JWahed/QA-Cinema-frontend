  ...
  return (
    <div>
      ...
      <p>
        ...
        of the BBFC over many years. They reflect current views on film, DVD and
        video game regulation. For more information,
        <a
      ...
      <Accordion defaultActiveKey="0">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            ...
            work is particularly suitable for pre-school children, this will be
            indicated in the Ratings Info.
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            ...
            an adult. Adults planning to take a child under 12 to view a 12A
            film should consider whether the film is suitable for that child. To
            help them decide, we recommend that they check the Ratings Info for
            that film in advance. No one younger than 12 may rent or buy a 12
            rated video work.
          </Accordion.Body>
        </Accordion.Item>
        ...
        <Accordion.Item eventKey="5">
          <Accordion.Header>
            ...
            ></img>
            R18 - To be shown only in Licensed Cinemas to Adults Only #6
          </Accordion.Header>
          <Accordion.Body>
            The R18 category is a special and legally-restricted classification
            primarily for explicit works of consenting sex or strong fetish
            material involving adults. Films may only be shown to adults in
            specially licensed cinemas, and video works may be supplied to
            adults only in licensed sex shops. R18 video works may not be
